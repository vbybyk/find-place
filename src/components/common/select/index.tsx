...
import { Select as BaseSelect, SelectRootSlotProps, SelectProps, SelectListboxSlotProps } from "@mui/base/Select";
...
const Select = forwardRef<HTMLDivElement, ISelectProps>((props: ISelectProps, ref) => {
  const { options, keyValue, ...rest } = props;
...
const AnimatedListbox = React.forwardRef(function AnimatedListbox<Value extends {}, Multiple extends boolean>(
...
const MuiSelect = React.forwardRef(function CustomSelect<TValue extends {}, Multiple extends boolean>(
  props: SelectProps<TValue, Multiple>,
  ref: React.ForwardedRef<HTMLButtonElement>
) {
  const { options, keyValue, onChange, ...rest } = props as ISelectProps;
